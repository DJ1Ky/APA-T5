...
"""    
    ...
    Para evitar problemas con la codificación en complento a dos de los valores negativos,
    al segundo se le suma 2 **(numBits -1), que deberán restarse en la decodificación.    
"""    
...
"""    
    ...
    bitsPerSample=8 devuelve la cadena "b"     
    bitsPerSample=16 devuelve la cadena "h"     
    bitsPerSample=32 devuelve la cadena "i"     
    En cualquier otro caso, eleva la excepción ValueError
...
"""    
    Lee el   fichero 'ficWave', que ha de ser del tipo WAVE y devuelve una tupla con la     
    información más relevante contenida en el mismo:    
...
"""    
    ...
    Se supone que la señal está codificada como PCM lineal.    
"""
